...
export default function Header() {
  return <header className="site-header"><div className="header-inner">
    ...
    <nav className="main-nav" aria-label="Primary navigation"><Link to="/">Fleet index</Link><a href="#about">About</a><a href="mailto:reservations@sunset-oia.com">Partner support <span aria-hidden="true">↗</span></a></nav>
